...
let SignupController = class SignupController {
    ...
    signup(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                yield this.signupService.signup(name, email, password);
...
exports.SignupController = SignupController = __decorate([
    (0, inversify_express_utils_1.controller)('/signup'),
    __param(0, (0, inversify_1.inject)('SignupServiceInterface')),
    __metadata("design:paramtypes", [SignupService_1.SignupService])
], SignupController);
//# sourceMappingURL=SignupService.controller.js.map